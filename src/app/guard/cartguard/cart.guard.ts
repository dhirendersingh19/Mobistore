...
export class CartGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad {
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      ...
      if(this.isLoggedIn){
        if(!(this.isAdmin)){
          ...
          console.log('Admin cant view cart');
          this.router.navigateByUrl('inventory');
          return false;
        }
      }else{
        alert('User Account required to View Cart');
